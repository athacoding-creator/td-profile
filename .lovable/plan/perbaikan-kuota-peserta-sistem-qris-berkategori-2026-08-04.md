...
1. Buat tabel kategori pembayaran yang dikelola admin (nama, keterangan, aktif, dan CTA ke No whatsapp untuk konfirmasi) — misalnya Kelas, Futsal, Camp. Kategori "Infaq" tetap bawaan sistem dan alurnya tidak diubah.
...
- Form tambah/edit: nama, kategori (dropdown dari kategori yang dikelola admin), keterangan, gambar QRIS, status aktif, dan CTA no whastapp untuk konfirmasi; preview seperti sekarang.
