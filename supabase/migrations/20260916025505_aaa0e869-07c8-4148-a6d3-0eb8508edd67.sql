...
BEGIN
  ...
  IF ev.event_type IN ('futsal', 'mini-soccer', 'olahraga', 'kelas-kajian', 'event', 'bedah-buku', 'ruqyah', 'bedah-buku-ruqyah') AND ev.registration_type = 'paid' THEN
...
UPDATE public.events SET event_type = 'event', allow_group_registration = true
WHERE event_type IN ('bedah-buku', 'ruqyah', 'bedah-buku-ruqyah');