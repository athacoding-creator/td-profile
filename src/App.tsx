...
const AdminPendaftar = lazy(() => import("./pages/admin/Pendaftar"));
const AdminKehadiran = lazy(() => import("./pages/admin/Registrations"));
            ...
            <AuthProvider>
              ...
              <ErrorBoundary>
                ...
                <Routes>
                  ...
                  <Route path="/profil/qr" element={<RequireAuth><AttendanceQR /></RequireAuth>} />
